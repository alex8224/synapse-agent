...
export const BottomBar: React.FC = () => {
  ...
  return (
    <>
      ...
      */}
      <footer className="material-chrome relative z-40 grid h-status w-full grid-cols-[1fr_auto_1fr] items-center gap-4 whitespace-nowrap border-t border-line px-3 font-numeric text-[11px] text-gray-500 shrink-0 select-none">
