...
export const ArtifactsPanel: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div
      ...
      className="absolute bottom-full left-0 z-50 mb-1 flex h-[32rem] w-[56rem] flex-col rounded-control border border-gray-200 material-flyout text-left shadow-flyout"
    >
