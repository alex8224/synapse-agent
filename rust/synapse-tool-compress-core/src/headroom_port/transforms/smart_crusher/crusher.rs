...
use crate::headroom_port::relevance::RelevanceScorer;
use crate::headroom_port::transforms::adaptive_sizer::compute_optimal_k;
use crate::headroom_port::transforms::anchor_selector::AnchorSelector;
...
impl SmartCrusher {
    ...
    fn smart_crush_content_with_hook(
        ...
        let result =
            crate::headroom_port::transforms::anchor_selector::python_safe_json_dumps(&crushed);
...
fn canonical_json_for_match(value: &Value) -> String {
    crate::headroom_port::transforms::anchor_selector::python_json_dumps_sort_keys(value)
}
...
mod tests {
    ...
    fn crusher_with_custom_scorer() {
        use crate::headroom_port::relevance::BM25Scorer;
    ...
    fn enable_ccr_marker_false_suppresses_marker_and_store() {
        ...
        use crate::headroom_port::transforms::smart_crusher::SmartCrusherBuilder;
        use std::sync::Arc;
