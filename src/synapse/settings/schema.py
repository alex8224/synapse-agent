...
def load_settings(**overrides: Any) -> Settings:
    ...
    # intentionally left to the concrete frontend bootstrap.
    from synapse.models.registry import apply_models_config_to_settings

    return apply_models_config_to_settings(settings)
